fMRIPost-resample is a postprocessing BIDS App that ingests preprocessed fMRI data for post-processing.
...
[Documentation `fmripost_resample.org <https://fmripost_resample.readthedocs.io>`_]
[Support `neurostars.org <https://neurostars.org/tags/fmripost_resample>`_]

License information
-------------------
*fMRIPost-resample* adheres to the
