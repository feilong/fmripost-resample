...
def write_derivative_description(input_dir, output_dir, dataset_links=None):
    ...
    from fmripost_resample import __version__

    DOWNLOAD_URL = f'https://github.com/nipreps/fmripost_resample/archive/{__version__}.tar.gz'
    ...
    desc['Name'] = 'fMRIPost-resample- ICA-template Postprocessing Outputs'
    ...
    # Add GeneratedBy from fMRIPost-resample
    desc['GeneratedBy'].insert(
        0,
        {
            'Name': 'fMRIPost-resample',
            'Version': __version__,
    ...
    if 'FMRIPOST_TEMPLATE_DOCKER_TAG' in os.environ:
        desc['GeneratedBy'][0]['Container'] = {
            'Type': 'docker',
            'Tag': f'nipreps/fmripost_resample:{os.environ["FMRIPOST_TEMPLATE_DOCKER_TAG"]}',
        }
