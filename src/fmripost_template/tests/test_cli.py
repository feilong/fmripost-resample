...
The tests in this file run the full fMRIPost-resample workflow on test data
...
from fmripost_resample.cli import run
from fmripost_resample.cli.parser import parse_args
from fmripost_resample.cli.workflow import build_boilerplate, build_workflow
from fmripost_resample.reports.core import generate_reports
from fmripost_resample.tests.utils import (
    check_generated_files,
    download_test_data,
    get_test_data_path,
)
from fmripost_resample.utils.bids import write_derivative_description


@pytest.mark.integration
def test_ds000001(data_dir, output_dir, working_dir):
    """Run fMRIPost-resample on ds000001 fMRIPrep derivatives."""
...
def _run_and_generate(test_name, parameters, test_main=True):
    ...
    if test_main:
        ...
        argv = ['fmripost_resample'] + parameters
