# fmripost_resample documentation build configuration file, created by
...
# Notes on fMRIPost-resample-specific style:
...
project = 'fMRIPost-resample'
author = 'The fMRIPost-resample developers'
...
# -----------------------------------------------------------------------------
bibtex_bibfiles = ['../src/fmripost_resample/data/boilerplate.bib']
bibtex_style = 'unsrt'
...
# html_title = u'fmripost_resample vversion'
...
htmlhelp_basename = 'fmripost_resample_doc'
...
latex_documents = [
    (master_doc, 'fmripost_resample.tex', 'fMRIPost-resample Documentation', author, 'manual'),
]
...
man_pages = [(master_doc, 'fmripost-template', 'fMRIPost-resample Documentation', [author], 1)]
...
texinfo_documents = [
    (
        master_doc,
        'fMRIPost-resample',
        'fMRIPost-resample Documentation',
        author,
        'fMRIPost-resample',
...
linkcode_resolve = make_linkcode_resolve(
    'fmripost_resample',
    'https://github.com/nipreps/fMRIPost-resample/blob/{revision}/{package}/{path}#L{lineno}',
)
